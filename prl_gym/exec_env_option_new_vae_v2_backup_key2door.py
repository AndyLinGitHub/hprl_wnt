...
class ExecEnv1(ExecEnv):
    ...
    def execute_pred_program(self, program_seq, demo=None, demo_len=None):
        ...
        pred_program['current_state'] = self.cnn_input_states[self.program_step] if self.fixed_input else final_state 
    ...
    def reset(self):
        ...
        self.init_state = self.cnn_input_states[0] if self.fixed_input else self.init_states[0][0] 
